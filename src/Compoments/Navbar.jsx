...
import { FaBars, FaTimes, FaBriefcase, FaUserFriends, FaEnvelope, FaBell, FaUserCircle, FaBuilding, FaFileAlt, FaQuestionCircle, FaCogs, FaFileContract, FaBlog, FaUserPlus, FaSignInAlt } from 'react-icons/fa';
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <div className="w-10 h-10 bg-gray-600 rounded">
            <a href="/"><img className='w-10 h-10' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSay6Qz3TtL3aItc57KWQgmbjndp2Hm5wJzPg&s" alt="Logo" /></a>
          </div>
          <input
            type="text"
            placeholder="Search..."
        ...
        {/* Menu Items */}
        <div className={`flex-col md:flex-row md:flex items-center space-x-6 ${menuOpen ? 'flex' : 'hidden'} md:flex`}>
          <div className="flex items-center space-x-4">
            <FaBriefcase className="text-xl cursor-pointer" title="Jobs" /> <span>Jobs</span>
            <FaUserFriends className="text-xl cursor-pointer" title="Connections" /><span>Connections</span>
          </div>
          ...
          <div className="w-8 h-8 rounded-full bg-gray-600 cursor-pointer">
            <img className='w-8 h-8 rounded-full' src="./assids/shubha.jpeg" alt="Profile" />
          </div>
        </div>
      </div>
    </nav>
